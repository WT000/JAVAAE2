...
| 5 (1, 5, 10)           | All transactions use the ReST client against the remote bank, specifically using the details currently configured in the properties.                | Transactions are logged to (Tomcat)/logs/ae2cart                                                                                                  |
